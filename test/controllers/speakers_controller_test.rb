...
class SpeakersControllerTest < ActionController::TestCase
  ...
  test "should create speaker" do
    assert_difference('Speaker.count') do
      post :create, speaker: { bio: @speaker.bio, description: @speaker.description, user_id: @speaker.user_id }
    end
  ...
  test "should update speaker" do
    patch :update, id: @speaker, speaker: { bio: @speaker.bio, description: @speaker.description, user_id: @speaker.user_id }
    assert_redirected_to speaker_path(assigns(:speaker))
  end
